...
class BaeLog
{
    ...
    {
        $this->secret = $secret;
        $this->loglevel = 16;    // 默认是notice
    }

    public function setLogLevel($level)
    {
    	//echo "设置的log等级为：$level<br/>";
        $this->loglevel = $level; 
        return true;
    }
    ...
    **/
    public static function getInstance($secret)
    {
        ...
        {
//         	echo 'Function getINstance get user or passwd is failed .... <br/>';
            return null;
        }
        ...
        if (self::$instance !== null)
        {
            ...
            {
            	echo '$instance->openServer() is failed ..... <br/>';
                $retrytimes++;
            }
        }
    ...
    **/
    ...
    {
//     	echo "Running function:Fatal, and logmsg = $logmsg<br/>";
